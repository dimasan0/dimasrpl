...
<body>
    ...
    <div class="p-1 my-container active-cont">
      ...
      <p class="px-3">Daftar Peminjaman Buku</p>
      <div class="container">
        ...
        <table class="table">
            <thead>
                ...
                <th>
                    <a href="tambahpeminjaman.php" class="btn btn-success">Tambah</a>
                </th>
            </thead>
            <tbody>
                <?php
                include 'koneksi.php';
                $data = mysqli_query($koneksi, "SELECT * FROM peminjaman") or die(mysqli_error($koneksi));
                ...
                <tr>
                    ...
                    <td><?php echo $baris['nama_peminjam']; ?></td>
                    <td><?php echo $baris['tanggal_pinjam']; ?></td>
                    <td><?php echo $baris['tanggal_kembali']; ?></td>
                    <td>
                        <a href="updatepeminjaman.php?id_buku=<?php echo $baris['id_buku']; ?>" class="btn btn-warning">Update</a>
                        <a href="deletepeminjaman.php?id_buku=<?php echo $baris['id_buku']; ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
                    <?php
                }
