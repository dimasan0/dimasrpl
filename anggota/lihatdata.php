...
<body>
    ...
    <div class="side-navbar active-nav d-flex justify-content-between flex-wrap flex-column" id="sidebar">
        ...
        <li href="#" class="nav-link">
          <a class="bx bx-user-check" href="profile.php"></a>
    ...
    <div class="p-1 my-container active-cont">
        ...
        <?php
            ...
            $data = mysqli_query($koneksi, "SELECT * FROM anggota WHERE id = '$_GET[kd]'") or die(mysqli_error($koneksi));
        ...
        <div class="panel-body">
            <table id="example" class="table table-hover table-bordered">
                ...
                <tr>
                    <td width="250">NPM</td>
                    <td width="550"><?php echo $baris['npm']; ?></td>
                </tr>
                <tr>
                    <td>Nama</td>
            ...
            <td>
                <a href="updatedata.php?id=<?php echo $baris['id']; ?>" class="btn btn-warning">Update Data</a>
            </td>
        </div>
    </div>
