      ...
      <div class="container">
        ...
        <table class="table">
            <thead>
                ...
                <th>Tanggal Input</th>
                <th>
                    <a href="tambahbuku.php" class="btn btn-success">Tambah</a>
                </th>
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                    ...
                    <td>
                        <a href="updatebuku.php?id_buku=<?php echo $baris['id_buku']; ?>" class="btn btn-warning">Update</a>
                        <a href="deletebuku.php?id_buku=<?php echo $baris['id_buku']; ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
                    <?php
                }
