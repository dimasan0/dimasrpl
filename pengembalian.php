...
<body>
    ...
    <div class="p-1 my-container active-cont">
      ...
      <p class="px-3">Daftar Pengembalian Buku</p>
      <div class="container">
        ...
        <table class="table">
            <thead>
                ...
                <th>
                    <a href="tambahpengembalian.php" class="btn btn-success">Tambah</a>
                </th>
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                    ...
                    <td>
                        <a href="updatepengembalian.php?id_buku=<?php echo $baris['id_buku']; ?>" class="btn btn-warning">Update</a>
                        <a href="deletepengembalian.php?id_buku=<?php echo $baris['id_buku']; ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
                    <?php
                }
