...
<body>
    ...
    <div class="p-1 my-container active-cont">
      ...
      <h5 class="px-3">Update Pengembalian</h5>
      <div class="container px-3">
        <?php
            include 'koneksi.php';
            $id_buku = $_GET['id_buku'];
            $data = mysqli_query($koneksi, "SELECT * FROM pengembalian WHERE id_buku = '$id_buku'") or die(mysqli_error($koneksi));
            $baris = mysqli_fetch_array($data);
        ?>
        <div class="col-md-6">
            <form action="prosesupdatepengembalian.php?id_buku=<?php echo $id_buku; ?>" method="post">
