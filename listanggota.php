      ...
      <div class="container">
        ...
        <table class="table">
            <thead>
                ...
                <th>Prodi</th>
                <th>
                    <a href="tambahanggota.php" class="btn btn-success">Tambah</a>
                </th>
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                    ...
                    <td>
                        <a href="updateanggota.php?id=<?php echo $baris['id']; ?>" class="btn btn-warning">Update</a>
                        <a href="deleteanggota.php?id=<?php echo $baris['id']; ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
                    <?php
                }
